...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        active: json["active"],
        resetPassCode: json["resetPassCode"],
        name: json["name"],
        email: json["email"],
        pass: json["pass"],
...
class Role {
  ...
  Role({this.name, this.menuOptions, this.groupOptions, this.privileges});
...
class MenuOption {
  ...
  MenuOption({this.name, this.page, this.icon});
...
class GroupOption {
  ...
  GroupOption({this.name, this.icon});
