...
class ProductScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _productItemData( title: 'Activo',      data: product.active.toString(), color: ( product.active ) ? Colors.green : Colors.red ),  
        ],
      ),
    );
  }
  ...
  _deleteInfo( context, Product product, String user ) async {

    final delete = await _productSVC.deleteProduct( uid: product.id, user: user );
