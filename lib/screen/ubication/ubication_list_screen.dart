...
class UbicationListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: TextField(
            ...
            decoration: InputDecoration(
                hintText: 'Busqueda de Ubicaciones',
      ...
      floatingActionButton: !!user.role.privileges.createUbications
  ...
  StreamBuilder<List<Ubication>> listUbication() {
    return StreamBuilder<List<Ubication>>(
        ...
        builder: (BuildContext context, AsyncSnapshot<List<Ubication>> snapshot) {
          ...
          for (final data in listStream) listUbication.add( _groupTile(context, data) );
